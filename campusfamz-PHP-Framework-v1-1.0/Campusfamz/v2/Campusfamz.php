...
function model($app_id, $action, $function, $param, $ext, $page, $parsed_args){
	   $this->$function($action, $param, $ext, $page, $parsed_args);
}


function login($action, $param, $ext, $page, $parsed_args){
...
function signup($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
...
function profiles($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
...
function users($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
...
function search($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
...
function friends($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
...
function photos($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
	...
	case 'PUT':
	    if($ext == 'caption'){
			  $functions->update_photo_caption($param, $parsed_args);
			  exit();
		}elseif($ext == 'cover'){
			  $functions->update_cover_photo($param, $parsed_args);
			  exit();
		}elseif($ext == 'dp'){
			  $functions->update_profile_photo($param, $parsed_args);
			  exit();
		}else{
		}
		break;
	case 'DELETE':
	    if($ext == 'comment'){
			  $functions->delete_photo_comment($param, $parsed_args);
			  exit();
		}elseif($ext == ''){
			  $functions->delete_photo($param, $parsed_args);
			  exit();
		}else{
		}
		break;
...
function feeds($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
...
function messages($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
...
function admins($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
...
function forums($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
	...
	case 'PUT':
	    if($ext == ''){
		      $functions->update_topic($param, $parsed_args);
			 exit();
		}else{
		}
		break;
	case 'DELETE':
	    if($ext == 'forum'){
		      $functions->delete_forum_post($param, $parsed_args);
			  exit();
		}elseif($ext == 'comment'){
			 $functions->delete_forum_comment($param, $parsed_args);
			 exit();
		}else{
			 $functions->update_topic($param, $parsed_args);
			 exit();
...
function slides($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
	...
	case 'PUT':
	    if($ext == ''){
		      $functions->update_slide($param, $parsed_args);
			  exit();
		}else{
		}
		break;
...
function developers($action, $param, $ext, $page, $parsed_args){
	$ErrorParser = $this->registry->getObject('ErrorParser');
	$functions = $this->registry->getObject('Functions');
